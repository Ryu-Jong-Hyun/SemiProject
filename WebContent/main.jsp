...
<html>
	<head>
		...
		<style>
			img#img{position: absolute; left: 28%; top: 200px; border: 1px solid black; width: 500px; height: 400px;}    
			input#pick{position: absolute; left: 29%; top: 210px; border: none; font-size: 20px;} 
