...
@WebServlet({ "/main", "/login", "/logout", "/join", "/overlay", "/searchId", "/searchPw", "/pwChange",
		"/memberUpdateForm", "/memberUpdate", "/updatePw", "/charge", "/coinListForm", "/successList1", "/review",
		"/successList2", "/reviewList", "/reviewDetail", "/myInquireList", "/inquire", "/inquireList", "/inquireDetail",
		"/reply", "/question", "/qnaDetail", "/qnaUpdate", "/qnaDelete", "/projectDetail", "/detail", "/qnaAnswer",
...
public class MainController extends HttpServlet {
	...
	private void dual(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/adminApprovalPlus":
			System.out.println("내역추가");
			service = new ProjectService(request,response);
			service.adminApprovalPlus();
			break;
			
		case "/adminApprovalList":
			System.out.println("내역확인");
			service = new ProjectService(request,response);
			service.adminApprovalList();
			break;
		}
	}
}
