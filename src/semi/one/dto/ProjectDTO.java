...
public class ProjectDTO {
	...
	private int dpo_don;
	private Date dpo_date;

	public int getDpo_don() {
		return dpo_don;
	}

	public void setDpo_don(int dpo_don) {
		this.dpo_don = dpo_don;
	}

	public Date getDpo_date() {
		return dpo_date;
	}

	public void setDpo_date(Date dpo_date) {
		this.dpo_date = dpo_date;
	}
